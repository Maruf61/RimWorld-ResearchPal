...
namespace ResearchPal
{
    ...
    public static class Assets
    {
        ...
        public static Texture2D RedBackground =
            SolidColorMaterials.NewSolidColorTexture(0.5f, 0f, 0f, .9f);

        public static Texture2D OrangeBackground =
            SolidColorMaterials.NewSolidColorTexture(0.98f, 0.7843137f, 0.0f, .9f);
